...
//@FeignClient注解来指定服务名进而绑定服务，然后再通过SpringMVC中提供的注解来绑定服务提供者提供的接口   客户端直接注入该服务,进行调用
//fallback = UacMqMessageApiHystrix.class  服务降级的时候执行该类，需要开启feign.hystrix.enabled=true    
