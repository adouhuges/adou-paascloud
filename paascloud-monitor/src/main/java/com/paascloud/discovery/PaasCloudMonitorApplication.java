...
//采取Turbine集群监控。Turbine有一个重要的功能就是汇聚监控信息，并将汇聚到的监控信息提供给Hystrix Dashboard来集中展示和监控。那我们就来看看Turbine集群监控如何使用。
@EnableTurbine	
@EnableHystrixDashboard //监控仪表盘  可根据设定端口在浏览器上访问
@EnableCircuitBreaker	//开启断路器功能  去除访问出错的服务端地址
@EnableAdminServer
